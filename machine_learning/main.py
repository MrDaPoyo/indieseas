...
def main():
    ...
    parser.add_argument("--img-size-min", type=int, default=1080, help="Enable multi-scale training with this min size (e.g., 1080 for 1080p images)")
    parser.add_argument("--img-size-max", type=int, default=4320, help="Enable multi-scale training with this max size")
